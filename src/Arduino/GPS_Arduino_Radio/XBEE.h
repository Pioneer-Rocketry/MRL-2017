...
/*This platform stuff should be implmeneted somewhere else.*/
   ...
   */
   ...
   long println(const char * message){long aLong = cmdPort->print(message); cmdPort->print("\n\r"); return aLong;}

   long println(int message, int format){long aLong = cmdPort->print(message, format); cmdPort->print("\n\r"); return aLong;}

   long println(float message, int format){long aLong = cmdPort->print(message, format); cmdPort->print("\n\r"); return aLong;}
